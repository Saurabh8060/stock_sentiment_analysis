...
//                 max_records: 1000,
//             });
//             setEmailStatus("Queued. We'll email you when the report is ready.");
//         } catch (err) {
...
//     }
//     if (error || !data) {
//         return <p className = "p-6 text-red-600">{error ?? "Dashboard unavailable"}</p>;
//     }
//     return (
//         <div className = "p-6 max-w-7xl mx-auto">
//             <div className = "rounded-[32px] border border-white/70 bg-white/70 p-8 shadow-2xl backdrop-blur">
//                 <div className = "flex flex-col md:flex-row md:items-end md:justify-between gap-6">
//                     <div>
//                         <p className = "text-xs uppercase tracking-[0.4em] text-slate-500">GDELT News Pulse</p>
//                         <h1
...
//                         </p>
//                     </div>
//                     <div className = "flex items-center gap-3 bg-slate-900 text-white px-4 py-2 rounded-full">
//                         <span className = "text-xs uppercase tracking-[0.3em]">Range</span>
//                         <span className = "text-sm">Last 3 Days</span>
//                     </div>
//                 </div>

//                 <div className = "mt-8 grid grid-cols-1 md:grid-cols-5 gap-4">
//                     <div className = "md:col-span-3 bg-white/80 rounded-2xl p-4 border border-white/70 shadow-lg">
//                         <h2 className = "text-sm uppercase tracking-[0.2em] text-slate-500 mb-3">Search Keyword</h2>
//                         <div className = "flex flex-col md:flex-row gap-3">
//                             <input
//                                 className = "border border-slate-200 rounded-xl p-3 flex-1 bg-white"
//                                 value = {keyword}
//                                 onChange = {(e) => setKeyword(e.target.value)}
//                                 placeholder = "e.g. AAPL or Apple stock"
//                             />
//                             <button className = "px-5 py-3 rounded-xl bg-slate-900 text-white" onClick = {submitSearch}>
//                                 Search
//                             </button>
//                         </div>
...
//                         </p>
//                     </div>
//                     <div className = "md:col-span-2 bg-gradient-to-br from-slate-900 to-slate-700 text-white rounded-2xl p-4 shadow-lg">
//                         <p className = "text-xs uppercase tracking-[0.2em] text-white/70">Keyword</p>
//                         <p className = "text-2xl font-semibold">{keyword}</p>
//                         <p className = "text-xs text-white/70 mt-2">Latest 100 articles</p>
//                     </div>
//                 </div>
//             </div>
...
//             <div className = "mt-8 bg-white/80 p-6 rounded-2xl shadow-lg backdrop-blur border border-white/70">
//                 <div className = "flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
//                     <div>
//                         <h2 className = "font-semibold text-slate-900">Email Full Date Range</h2>
//                         <p className = "text-sm text-slate-500">Request up to 1000 articles for a custom date range.</p>
//                     </div>
//                     <div className = "text-xs uppercase tracking-[0.2em] text-slate-500">Email Queue</div>
//                 </div>
//                 <div className = "grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
//                     <label className = "text-sm text-slate-600">
//                         Start Date
//                         <input
//                             className = "mt-1 w-full border border-slate-200 rounded-xl p-2 text-sm bg-white"
//                             type = "date"
//                             value = {startDate}
...
//                     </label>
//                 </div>
//                 <button className = "px-5 py-2 rounded-xl bg-slate-900 text-white text-sm" onClick = {submitEmailRequest}>
